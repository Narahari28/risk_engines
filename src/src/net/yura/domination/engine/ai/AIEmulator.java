...
import net.yura.domination.engine.ai.logic.AIDominationCopy;
 ...
 * @author Yura Mamyrin
 */
public class AIEmulator extends AbstractAICopy {

    public int getType() {
        return AIDominationCopy.PLAYER_AI_EMULATOR;
    }
...
//
//  HTTP POST request
// 	private String sendPost(int gameState, int[] x_state, Object[] offLimits, int maxArmies) throws Exception {
...
//    		String ans = "";
//    		try {
//    			ans = sendPost(4, x_state, new Object[0], -1);
//    		} catch (Exception e) {
//    			e.printStackTrace();
//    		}
//    		if(ans.contains("\"")) {
...
//    		System.out.println("SCREEEEEEEEEEEEEEEEEEEEEE");
//		int[] armies = getArmies();
//		int[] x_state = new int[armies.length + 2];
//		for(int i = 0; i < armies.length; i++) {
//			x_state[i] = armies[i];
...
//		String ans = "";
//		try {
//			ans = sendPost(10, x_state, new Object[0], -1);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//		if(ans.contains("\"")) {
